...
BgSundayDantooineEvent.CONFIG = {
	...
	checkpoints = {
		{
			name = "Ruined Outpost",
			trigger = { x = -5600, z = 0, y = 6200, radius = 96 },
			spawn = { x = -5520, z = 0, y = 6130, heading = 0 },
			waypointName = "Sunday Ambush 1",
			waypointDesc = "Advance south to the Ruined Outpost trigger point.",
		},
		{
			name = "Kath Hound Flats",
			trigger = { x = -5500, z = 0, y = 5500, radius = 96 },
			spawn = { x = -5420, z = 0, y = 5430, heading = 0 },
			waypointName = "Sunday Ambush 2",
			waypointDesc = "Press south across the Kath Hound Flats.",
		},
		{
			name = "Broken Spire",
			trigger = { x = -5350, z = 0, y = 4800, radius = 96 },
			spawn = { x = -5270, z = 0, y = 4730, heading = 0 },
			waypointName = "Sunday Ambush 3",
			waypointDesc = "Continue south to the Broken Spire ambush point.",
		},
		{
			name = "Southern Gully",
			trigger = { x = -5200, z = 0, y = 4100, radius = 96 },
			spawn = { x = -5120, z = 0, y = 4030, heading = 0 },
			waypointName = "Sunday Ambush 4",
			waypointDesc = "Push into the Southern Gully.",
		},
		{
			name = "Fell Ravine",
			trigger = { x = -5100, z = 0, y = 3400, radius = 96 },
			spawn = { x = -5020, z = 0, y = 3330, heading = 0 },
			waypointName = "Sunday Ambush 5",
			waypointDesc = "Descend into Fell Ravine.",
		},
		{
			name = "Scorched Flats",
			trigger = { x = -5000, z = 0, y = 2700, radius = 96 },
			spawn = { x = -4920, z = 0, y = 2630, heading = 0 },
			waypointName = "Sunday Ambush 6",
			waypointDesc = "Cross the Scorched Flats.",
		},
		{
			name = "Shattered Pass",
			trigger = { x = -4900, z = 0, y = 2000, radius = 96 },
			spawn = { x = -4820, z = 0, y = 1930, heading = 0 },
			waypointName = "Sunday Ambush 7",
			waypointDesc = "Breach the Shattered Pass.",
		},
		{
			name = "Southern Breach",
			trigger = { x = -4800, z = 0, y = 1300, radius = 96 },
			spawn = { x = -4720, z = 0, y = 1230, heading = 0 },
			waypointName = "Sunday Ambush 8",
			waypointDesc = "Hold the Southern Breach and finish the run.",
		},
	},
	bossPool = {
