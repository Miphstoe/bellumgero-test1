lok_domesticated_snorbal_lair_neutral_medium = Lair:new {
	customName = "Domesticated Snorbal Lair",
	mobiles = {{"domesticated_snorbal",1}},
	spawnLimit = 15,
...
addLairTemplate("lok_domesticated_snorbal_lair_neutral_medium", lok_domesticated_snorbal_lair_neutral_medium)
