lok_domesticated_gurnaset_lair_neutral_medium = Lair:new {
	customName = "Domesticated Gurnaset Lair",
	mobiles = {{"domesticated_gurnaset",1}},
	spawnLimit = 15,
...
addLairTemplate("lok_domesticated_gurnaset_lair_neutral_medium", lok_domesticated_gurnaset_lair_neutral_medium)
